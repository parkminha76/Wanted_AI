...
docX-ray는 PDF·Word·Excel·텍스트·이미지 문서에서 개인정보와 프롬프트 인젝션을 탐지하고, 원본 형식을 유지한 마스킹 사본을 만드는 privacy-first 정보유출 방지 서비스입니다. AI가 만든 사칭·피싱 상황에서 사용자의 대응을 훈련하고, 위험한 답장은 같은 스캐너로 전송 전에 검사합니다.
